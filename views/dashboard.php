                ...
                <div class="card-header bg-white border-0">
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <i class="fa-solid fa-plus fa-3x text-info" data-bs-toggle="modal" data-bs-target="#add-product"
                            ...
                            ?>
                                <tr>
                                    ...
                                    ?>
                                        ...
                                        btn-success btn-sm" title="Buy Product"><i class="fa-solid fa-cashregister"></i></a>
                                        </td>
                                    <?php
                                        }
                                        else
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-5">
                        <h1 class="display-4 fw-bold text-center"><i class="fa-solid fa-box"></i>Add Product</h1>
                        ...
                        <form action="../actions/product-actions.php" method="post" class="w-75 mx-auto pt-4 p-5">
                            <div class=" row mb-3">
                                <div class="col-md">
                                    ...
                                    <input type="text" name="product_name" class="form-control" aria-label="price"
                                    aria-describedby="price-tag">
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
