...
<body>
    <div class="container mt-5">
        <div class="card boder-0 mx-auto w-50">
            <div class="card-header boder-0 bg-white mt-5">
            ...
            <div class="card-body">
                <form action="../actions/user-actions.php" method="post" class="w-75 mx-auto">
                    ...
                    <div class="row mb-3 g-2">
                        <label for="password" class="col-md-3 col-form-label text-md-end text-scondary small">Password</label>
                        <div class="col-md-8">
                    ...
                    <div class="row mb-3 g-2">
                        <div class="col-md-8 offset-md-3 text-center">
                            ...
                            data-bs-target="#registration">Create an Account</button>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <form action="../actions/user-actions.php" method="post" class="w-75 mx-auto pt-4 p-5">
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="first-name" class="form-label small text-secondery">First Name</label>
                                        <input type="text" name="first_name" id="first-name" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="last-name" class="form-label small text-secondery">Last Name</label>
                                        <input type="text" name="last_name" id="last-name" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-md">
                                        <label for="username" class="form-label small text-secondery">UserName</label>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md">
                                        <label for="password" class="form-label small text-secondery">Password</label>
